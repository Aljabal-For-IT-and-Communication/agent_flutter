      ...
      child: Row(
        ...
        children: [
          Container(
            ...
            child: item.avatar==null?Image.asset('assets/images/head1.png'):Image.network("${SERVER_API_URL}${item.avatar}"),
          ),
          Container(
            width: 240.w,
...
class BuildMenuItem extends StatelessWidget {
  ...
  const BuildMenuItem({Key? key,required this.title,required this.description,required this.callFunc}) : super(key: key);
        ...
        child: Container(
          ...
          child: Row(
            ...
            Container(
              width: 24.h,
              height: 24.h,
              child: Image.asset("assets/images/arrow_right.png",fit: BoxFit.fitWidth,),
            ),
          ],),),
      ),
    );
