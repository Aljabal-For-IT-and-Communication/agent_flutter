...
class _ShippingOperationPageState extends State<ShippingOperationPage> {
      ...
      if ((scrollController.offset + 10) >
        ...
        if (lastPostCalled == null ||
          ...
          Logic(context: context)
              .shippingOperation(state.day, state.shippingOperationList.length);
        }
      }
    });
  }
  ...
  Widget build(BuildContext context) {
    return BlocBuilder<ShippingOperationBloc, ShippingOperationState>(
                        ...
                        children: [
                          ...
                          GestureDetector(
                            onTap: () {
                              context
                                  .read<ShippingOperationBloc>()
                                  .add(ShippingOperationChanged([]));
                              EasyLoading.show(
                                  indicator: CircularProgressIndicator(),
                                  maskType: EasyLoadingMaskType.clear,
                                  dismissOnTap: true);
                              Logic(context: context)
                                  .shippingOperation(state.day, 0);
                            },
                            child: Container(
                              width: 160.w,
                              height: 46.h,
