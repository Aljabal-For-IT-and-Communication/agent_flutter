        ...
        child: CustomScrollView(slivers: [
          ...
          SliverPadding(
            ...
            sliver: SliverToBoxAdapter(
                child: Column(
                  children: [
                    BuildListItem(title:"change password".tr(),iconImage: "assets/icons/profile.png",callFunc: (){
                      Navigator.of(context).pushNamed(AppRoutes.ChangePassword);
                    },),
                    BuildListItem(title:"Contact type".tr(),iconImage: "assets/icons/wifi.png",callFunc: (){
                      Navigator.of(context).pushNamed(AppRoutes.ContactType);
                    },),
                    BuildNotification(),
                    BuildListItem(title:"Contact us".tr(),iconImage: "assets/icons/phone.png",callFunc: () async{
                     // Navigator.of(context).pushNamed(AppRoutes.Contact);
                      ...
                      var result = await sqlDbService.queryByTokenRow(userItem.token);
                      if(result.isEmpty){
                        await sqlDbService.insertChatUser(userItem);
                      }
                      await Navigator.of(context).pushNamed(AppRoutes.Chat,arguments: userItem);
                    },),
                    BuildListItem(title:"About the application".tr(),iconImage: "assets/icons/question.png",callFunc: (){
                      Navigator.of(context).pushNamed(AppRoutes.About);
                    },),
                    BuildLanguage(),
                    BuildListItem(title:"Sign out".tr(),iconImage: "assets/icons/close.png",callFunc: (){
                      showDialog(
                          context: context,
