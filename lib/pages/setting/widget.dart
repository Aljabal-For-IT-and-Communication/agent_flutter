        ...
        child: Row(
          ...
          children: [
            ...
            Container(
              width: 24.h,
              height: 24.h,
              child: Switch(value: state.isOpen,activeColor: AppColors.primaryElement, onChanged: (bool value) {
      ...
      child: Row(
        ...
        children: [
          ...
          Container(
            width: 24.h,
            height: 24.h,
            child: Switch(value: state.language,activeColor: AppColors.primaryElement, onChanged: (bool value) {
              // 切换语言
